...
| set out        | leave on a trip                                                                   | 출발하다(대모험) |
| grow up        | change from a child to an adult                                                   |           |
| break down     | stop working                                                                      | 고장나다      |
...
| realize        | became aware                                                                      |           |
| direction      | way something is going                                                            |           |
| career         | job or occupation                                                                 |           |
| develop        | grow over time                                                                    |           |
| opportunity    | chance to do something                                                            |           |
| relationship   | conneciton ,friendship                                                            |           |
| eventually     | finally, after sometime                                                           |           |
...
`had p.p`
- 그 과거의 한포인트보다 더 과거일때
	- simple past랑 주로같이 쓰임
- when, by the time / already, just
### Simple future
`Will`
- 미래에 대한 사실
- 예측
